...
let urlApi = "https://gateway.marvel.com:/v1/public/characters?ts=1&apikey=cc25a8d815b08a07d1f66b16e2079cff&hash=9e25f1c95eb74bd5d42f42216b82ded3";
// "https://gateway.marvel.com:/v1/public/characters?name=" + heroName +
// "ts=1&apikey=cc25a8d815b08a07d1f66b16e2079cff&hash=9e25f1c95eb74bd5d42f42216b82ded3";
let heroName = ["Spider-Man", "Thor", 'Capitan America', 'Black Panther', 'Dr Strange', 'Ant man', 'Iron man', 'Hulk', 'Deadpool', 'Ghost Rider', 'Captain Marvel', 'Daredevil'];
${#Name - 1 }.text(heroName)
...
const marvel = {
  render: () => {
    ...
    fetch(urlApi)
      ...
      .then((json) => {
        consolelog(json)
        for (var i = 0; i < heroName.length;)json.data.results) {
